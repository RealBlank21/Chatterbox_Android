...
public class CharacterViewModel extends AndroidViewModel {
    ...
    private final LiveData<List<com.example.testing.data.local.entity.Character>> displayedCharacters;
    ...
    public LiveData<List<com.example.testing.data.local.entity.Character>> getDisplayedCharacters() { return displayedCharacters; }
    ...
    public void update(com.example.testing.data.local.entity.Character character) { characterRepository.update(character); }
    public void delete(com.example.testing.data.local.entity.Character character) { characterRepository.delete(character); }
